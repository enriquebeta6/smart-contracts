...
// Typings
import { BUSDTokenMock } from '../../typechain/BUSDTokenMock';
import { BUSDTokenMock__factory } from '../../typechain/factories/BUSDTokenMock__factory';

import { ToysLegendDonation } from '../../typechain/ToysLegendDonation';
...
describe('ToysLegendDonation', () => {
  ...
  it('Should returns a successful donation', async () => {
    ...
    const expectedBalanceOfDeployer = ethers.utils.parseEther('50025');
